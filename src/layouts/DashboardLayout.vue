      ...
      <div class="flex-1">
        <router-link to="/" class="-m-1.5 p-1.5" @click="scrollToTop()">
          <img src="/assets/img/logo.png" alt=""
            class="transition-all ease-in duration-150 w-[150px] h-auto scale-100 hover:scale-90">
        </router-link>
      </div>
      ...
      <div class="flex gap-x-7 border border-transparent pt-6 pb-6">
        ...
        <router-link :to="{ name: item.name, hash: item.hash }" v-slot="{ isActive }" class="relative"
          ...
          <div
            ...
            <p
              class="transition-all ease-in duration-150 text-[0.8rem] sm:text-[0.85rem] md:text-[0.75rem] lg:text-[0.85rem] xl:text-[0.9rem] 2xl:text-[0.95rem] leading-6 text-bluecf font-medium hover:font-bold ">
              {{ item.text }}</p>
          </div>
        </router-link>
      ...
      <div class="flex gap-x-7 pl-7 pt-3 pb-3 items-center">
        <router-link to="/faq" @click="scrollToTop()">
          <button
            ...
            <p
              class="text-[#04B2CA] text-[0.8rem] sm:text-[0.85rem] md:text-[0.75rem] lg:text-[0.85rem] xl:text-[0.9rem] 2xl:text-[0.95rem] font-medium group-hover:pr-2 h-auto flex justify-center items-center pt-0.5">
              CONTACTO</p>
            <IconEast
      ...
      <div class="px-4">
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center justify-center">
            <a class="inline-flex items-center justify-center rounded-full bg-bluelightcf px-2 py-2" href="/login">
