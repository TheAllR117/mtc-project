                ...
                <div class="relative m-0 w-full h-full">
                    <div
                        ...
                        <div class="w-full h-auto flex justify-center items-center mb-[30px] md:my-[30px]">
                            <h2
                                :class="[`${visibility.section2 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} text-bluecf font-bold font-muller text-[1.6rem] sm:text-[1.7rem] lg:text-[1.8rem] xl:text-[2rem] 2xl:text-[2.2rem] `]">
                                Nuestras <span class="text-[#04B2CA]">soluciones</span> <span
                                    class="bg-[url(/assets/img/emoji-4.webp)] bg-cover text-transparent">**</span></h2>
                        </div>
                        ...
                        <div
                            class="mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-4 gap-14 items-start lg:max-w-none">

                            <div v-for="(item, index) in solutionAll" :key="index"
                                :class="[`${visibility.section2 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} flex flex-col h-full min-h-[320px] transition-all ease-in duration-150 border border-slate-200 rounded-[20px] shadow-lg text-bluecf overflow-hidden group bg-white hover:bg-bluecf cursor-pointer `]">
                                <!-- Image -->
                                <!-- <img class="object-cover h-48 w-full bg-yellow" src="./equal-height-01.jpg" width="304" height="192" alt="Course 01"> -->

                                <img class="transition-all ease-in duration-150 relative-0 group-hover:scale-110 object-cover h-48 w-full"
                                    v-lazy="{
                                        src: item.img!.url,
                                        loading: '/assets/img/placeholder.webp',
                                        error: '/assets/img/placeholder.webp',
                                        delay: 250
                                    }" loading="lazy" alt="" width="304" height="192" />
                                <!-- Card Content -->
                                <div
                                    class="flex-1 flex flex-col p-6 rounded-[40px_0px_0px_0px] relative  transition-all ease-in duration-150 w-full text-left z-10 bg-white mt-[-35px] group-hover:bg-bluecf">
                                    <svg width="53" height="45" viewBox="0 0 53 45" fill="none"
                                        xmlns="http://www.w3.org/2000/svg"
                                        class="transition-all ease-in duration-150 absolute top-[-45px] right-[-1px] fill-white group-hover:fill-bluecf">
                                        <path
                                    ...
                                    <div class="flex-1">
                                        <!-- Header -->
                                        <div class="w-full h-auto flex justify-between items-center font-muller">
                                            <p
                                                class="transition-all ease-in duration-150 text-bluecf group-hover:text-white text-[1.1rem] md:text-[1.15rem] lg:text-[1.2rem] xl:text-[1.3rem] 2xl:text-[1.4rem] font-muller font-bold">
                                                {{ item.title }}
                                            </p>
                                            <div class="relative group/item" v-if="item.infoTooltip != ''">
                                                <IconInfo class="group-hover:text-white hover:scale-90" />
                                        ...
                                        <div
                                            class="transition-all ease-in duration-150 w-full h-[1.5px] bg-graycf my-2 group-hover:bg-bluelightcf">
                                        </div>
                                        <p
                                            class="transition-all ease-in duration-150 text-bluecf group-hover:text-white font-muller text-[1rem] md:text-[1rem] lg:text-[1rem] xl:text-[1.1rem] font-light">
                                            {{ item.text }}
