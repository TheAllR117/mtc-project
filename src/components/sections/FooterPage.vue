<template>
    <div class="h-full w-full !font-muller bg-white overflow-hidden">
        ...
        <!-- Footer -->
        <footer class="w-full bg-bluecf" id="section7">
            <div class="mx-auto max-w-full md:px-20">
                <!--Grid-->
                <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">

                    <router-link to="/" @click="scrollToTop()">
                        <div class="flex justify-center">
                            <!-- <img src="/assets/img/logo-footer.webp" alt=""
                                :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} transition-all ease-in duration-150 w-[150px] h-auto scale-100 hover:scale-90`]"> -->
                            <img :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} transition-all ease-in duration-150 w-[150px] h-auto scale-100 hover:scale-90`]"
                                v-lazy="{
                    ...
                    <ul
                        class="max-lg:hidden flex text-lg text-center items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500 ">
                        <li class="text-white">
                            <div>
                                <p
                                    :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} text-[0.85rem] md:text-[0.9rem] xl:text-[1.05rem]`]">
                                    © 2023 Digitalquo.</p>
                            </div>
                            <div class="flex flex-row gap-x-5">
                                <router-link to="/privacy-policy" @click="scrollToTop()">
                                    <p
                                        :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} transition-all ease-in duration-150 text-[0.85rem] md:text-[0.9rem] xl:text-[1.05rem] cursor-pointer border-x-2 border-x-transparent border-t-transparent border-t-2 border-b-2 border-white hover:border-2 hover:border-x-white hover:border-t-white px-2 py-1`]">
                                        Política de privacidad</p>
                                </router-link>
                                <router-link to="/privacy-cookies" @click="scrollToTop()">
                                    <p
                                        :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} transition-all ease-in duration-150 text-[0.85rem] md:text-[0.9rem] xl:text-[1.05rem] cursor-pointer border-x-2 border-x-transparent border-t-transparent border-t-2 border-b-2 border-white hover:border-2 hover:border-x-white hover:border-t-white px-2 py-1`]">
                    ...
                    <div class="max-md:w-full flex gap-x-12 lg:gap-x-6 justify-center">
                        ...
                        <a href="https://www.facebook.com/cfditotal"
                            :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} transition-all ease-in duration-150 w-9 h-9 flex justify-center items-center scale-100 hover:scale-[0.8]`]">
                            <svg class=" w-[1.5rem] md:w-[1.5rem] lg:w-[1.4rem] xl:w-[1.4rem] 2xl:w-[1.5rem]"
                        ...
                        <a href="mailto:hola@cfditotal.com"
                            :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} transition-all ease-in duration-150 w-9 h-9 flex justify-center items-center scale-100 hover:scale-[0.8]`]">
                            <svg class=" w-[1.5rem] md:w-[1.5rem] lg:w-[1.4rem] xl:w-[1.4rem] 2xl:w-[1.5rem]"
                    ...
                    <ul
                        class="max-lg:flex hidden text-lg text-center items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                        <li class="text-white">
                            <div>
                                <p
                                    :class="[`${visibility.section7 ? 'animate-fadeUp' : 'animate-fadeUpOut opacity-0'} text-[0.85rem] md:text-[0.9rem] xl:text-[1.05rem]`]">
