<template>
  <section
    class="min-h-screen flex items-stretch bg-no-repeat bg-cover relative text-white bg-[url('/img/backgroud_login.png')] font-lato"
  >
    <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-1">
      <div
        class="absolute lg:hidden z-10 inset-0 bg-no-repeat bg-cover items-center bg-[url('/img/backgroud_login.png')]"
      >
        <div
          class="absolute bg-gradient-to-r from-secundary to-primary opacity-40 inset-0 z-0"
        ></div>
      </div>
      <div class="w-full py-6 z-20">
        <div class="text-left sm:w-2/3 w-full px-10 lg:px-0 mx-auto pb-8">
        ...
        <form @submit.prevent="login" class="sm:w-2/3 w-full px-10 lg:px-0 mx-auto">
          <div class="mt-6">
            <InputCustom
              ...
              v-model="form.email"
              bg-label="bg-[#0c2c4b]"
              focus-color-border="focus:border-white"
          ...
          <div class="flex justify-between pt-4">
            <a href="googlechrome://www.digitalquo.com" class="justify-self-start pt-2"
              >¿Olvidaste tu contraseña?</a
            >
            <ButtonLoading label="Entrar" :disable="!formValido" :is-loading="isLoading" width="w-6/12 md:w-4/12" width-loading="w-2/12" />
          </div>
    ...
    <div class="lg:flex w-1/2 hidden">
      <div class="absolute bg-gradient-to-r from-secundary to-primary opacity-40 inset-0 z-0"></div>
    </div>
  </section>
  <ModalCustom
    :is-open="showModal"
